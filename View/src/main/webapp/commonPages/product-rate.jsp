<%-- 
    Document   : product-rate
    Created on : Apr 21, 2019, 5:08:32 PM
    Author     : maimo
--%>
					...
					<div class="p-b-30 m-lr-15-sm">
						...
						<div class="flex-w flex-t p-b-68">
							...
							<div class="size-207">
								...
								<p class="stext-102 cl6">
									Quod autem in homine praestantissimum atque optimum est, id deseruit. Apud ceteros
									autem philosophos
								</p>
							</div>
						</div>
						...
						<!-- Add review -->
                                                <form class="w-full" method="post" action="rate">
