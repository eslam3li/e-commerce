                  ...
                  <div class="card-body card-block">
                    <form name="productForm" action="" method="post" enctype="multipart/form-data" class="form-horizontal">                                                
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                          <input type="text" id="text-input"  name="productName" required="true" class="form-control">
                        </div>
                      </div>   
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                          <textarea type="text" id="text-input" name="description" required="true" class="form-control"></textarea>
                        </div>
                      </div>                                                            
                      <br>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                          <input type="number" name="basePrice" required="true" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                          <input type="number" name="sellingPrice" required="true" class="form-control">
                        </div>
                      </div>

                      <div class="row form-group">
                        <div class="col col-md-3">
                          <label for="text-input" class=" form-control-label">Sale price<br>If you are offering sales</label>
                        </div>
                        <div class="col-12 col-md-9">
